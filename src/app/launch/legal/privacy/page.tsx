...
export const metadata = {
  title: "Privacy Policy — Dubio",
  description: "Learn how Dubio collects, uses, and protects your data.",
};
          ...
          <FadeInView>
            <div className="mb-8">
              <span className="inline-block px-3 py-1 rounded-full text-xs bg-white/5 text-white/40 font-[family-name:var(--font-syne)]">
                Last updated: {new Date(privacyPolicy.lastUpdated).toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}
              </span>
            </div>
